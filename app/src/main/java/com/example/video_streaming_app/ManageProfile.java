...
import com.example.video_streaming_app.databinding.ActivityManageProfileBinding;
...
public class ManageProfile extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding.uimage.setOnClickListener(view -> Dexter.withContext(getApplicationContext())
        ...
        binding.btnupdate.setOnClickListener(view -> updateToFirebase());
    ...
    protected void onActivityResult(int requestCode, int resultCode, @Nullable Intent data) {
        ...
        if(requestCode==101 && resultCode==RESULT_OK)
        {
            ...
            try {
                ...
                binding.uimage.setImageBitmap(bitmap);
            }catch (Exception ex)
            {
        ...
        uploader.putFile(filepath)
                .addOnSuccessListener(taskSnapshot -> uploader.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                    ...
                    public void onSuccess(Uri uri) {
                        ...
                        map.put("uname",binding.uname.getText().toString());
    ...
    protected void onStart() {
        ...
        dbreference.child(UserID).addValueEventListener(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot snapshot) {
                if(snapshot.exists()) {
                    binding.uname.setText(Objects.requireNonNull(snapshot.child("uname").getValue()).toString());
                    Glide.with(getApplicationContext()).load(Objects.requireNonNull(snapshot.child("uimage").getValue()).toString()).into(binding.uimage);
                }
            }
